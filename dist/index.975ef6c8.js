...
var _btnShowMore = require("./js/btn-show-more");
var _openFiveDays = require("./js/open-five-days");
var _search = require("./js/search");
var _todaySection = require("./js/today-section");
var _sectionMain = require("./js/section-main");
var _fiveDays = require("./js/five-days");
var _chart = require("./js/chart");
var _moreInfo = require("./js/more-info");
var _scrollMoreinfo = require("./js/scroll-moreinfo");

},{"./js/api":"9u7qN","./js/btn-show-more":"7PMBv","./js/search":"4TESp","./js/section-main":"8rlnq","./js/five-days":"1XLKS","./js/chart":"4jBvm","./js/more-info":"cHLki","./js/scroll-moreinfo":"kaFCt","./js/open-five-days":"gYKtQ","./js/today-section":"4mmsu"}],"9u7qN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchForecast", ()=>fetchForecast);
parcelHelpers.export(exports, "fetchForecastByGeolocation", ()=>fetchForecastByGeolocation);
parcelHelpers.export(exports, "fetchCurrentWeather", ()=>fetchCurrentWeather);
parcelHelpers.export(exports, "fetchCurrentWeatherByGeolocation", ()=>fetchCurrentWeatherByGeolocation);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const ENDPOINT = "https://api.openweathermap.org";
const API_KEY = "d52884a2e04f7a405073b1f70d08c546";
async function fetchForecast(query, temperatureUnit) {
    const queryString = `${ENDPOINT}/data/2.5/forecast?q=${query}&appid=${API_KEY}&units=${temperatureUnit}`;
    const response = await (0, _axiosDefault.default).get(queryString);
    return response.data;
}
async function fetchForecastByGeolocation(geolocation, temperatureUnit) {
...
async function fetchCurrentWeather(query, temperatureUnit) {
    const queryString = `${ENDPOINT}/data/2.5/weather?q=${query}&appid=${API_KEY}&units=${temperatureUnit}`;
    const response = await (0, _axiosDefault.default).get(queryString);
    return response.data;
}
async function fetchCurrentWeatherByGeolocation(geolocation, temperatureUnit) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7PMBv":[function(require,module,exports) {
...
btnShowMoreRight.addEventListener("click", ()=>{
    ...
    if (window.matchMedia("(min-width: 768px) and (max-width: 1027px)").matches) moreInfo.scrollLeft += 100;
});

},{}],"4TESp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleSelectedFavorite", ()=>handleSelectedFavorite);
var _sectionMain = require("./section-main");
var _fiveDays = require("./five-days");
var _todaySection = require("./today-section");
var _sectionDate = require("./section-date");
var _moreInfo = require("./more-info");
...
addButton.addEventListener("click", ()=>{
    ...
    if (shownFavorites.length < 4) shownFavorites.push(value);
    setFavoritesList();
});
prevButton.addEventListener("click", ()=>{
    ...
    if (indexOfFirstShown > 0) {
        shownFavorites = shownFavorites.filter((favorite)=>favorite !== shownFavorites[3]);
...
nextButton.addEventListener("click", ()=>{
    ...
    if (indexOfLastShown < favorites.length - 1) {
        shownFavorites = shownFavorites.filter((favorite)=>favorite !== shownFavorites[0]);
...
function getInitialShownFavorites() {
    ...
    if (favorites.length < 4) for(let index = 0; index < favorites.length; index++)shownFavorites.push(favorites[index]);
    else for(let index1 = 0; index1 < 4; index1++)shownFavorites.push(favorites[index1]);
}
...
async function handleSelectedFavorite(city) {
    await (0, _sectionMain.updateCityImage)(city);
    (0, _todaySection.updateCurrentWeather)(city);
    (0, _sectionDate.updateCurrentDate)(city);
    (0, _moreInfo.updateSelectedCity)(city);
}
function handleSelectFavorite(event) {
    const value = event.target.value;
    handleSelectedFavorite(value);
    (0, _fiveDays.fetchAndUpdateForecast)(value);
}
...
function deleteValueFromShownFavorites(favorites, value) {
    ...
    if (indexOfLastShown < favorites.length - 1) {
        shownFavorites = shownFavorites.filter((f)=>f !== value);
        shownFavorites.push(favorites[indexOfLastShown + 1]);
    } else shownFavorites = shownFavorites.filter((f)=>f !== value);
}
function addValueToLocalStorage(value) {
    if (value === "") return;
    const cities = localStorage.getItem("cities");
    if (cities === null) localStorage.setItem("cities", JSON.stringify([
        value
    ]));
    else {
...
},{"./section-main":"8rlnq","./five-days":"1XLKS","./section-date":"5q5fe","./more-info":"cHLki","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./today-section":"4mmsu"}],"8rlnq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateCityImage", ()=>updateCityImage);
var _pixabayApi = require("./pixabay-api");
async function updateCityImage(city) {
    const imageUrl = await (0, _pixabayApi.getCityImage)(city);
...
},{"./pixabay-api":"4M0T7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4M0T7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCityImage", ()=>getCityImage);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
async function getCityImage(city) {
    ...
    const response = await (0, _axiosDefault.default).get(`${ENDPOINT}${requestParams}`);
    return response.data.hits[0].largeImageURL;
}

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1XLKS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchAndUpdateForecast", ()=>fetchAndUpdateForecast);
...
async function fetchForecast5Day(e) {
    ...
    if (window.matchMedia("(min-width: 768px)").matches) showRight.classList.add("is-hidden");
    buttonList.classList.remove("style-fivedays");
    chart.classList.add("is-hidden");
    try {
        const forecastData = await (0, _api.fetchForecast)(input.value, temperatureUnit);
...
function updateForecast(dailyData) {
    for(let i = 0; i < 5; i++){
        ...
        day.textContent = dateItem.toLocaleString("default", {
            weekday: "long"
        });
...
async function fetchAndUpdateForecast(cityName) {
    try {
        const forecastData = await (0, _api.fetchForecast)(cityName, temperatureUnit);
        city.textContent = forecastData.city.name;
        const dailyData = getDailyData(forecastData);
        updateForecast(dailyData);
    } catch (error) {
...
async function handleFavoriteSelection(event) {
    const value = event.target.value;
    (0, _search.handleSelectedFavorite)(value);
    await fetchAndUpdateForecast(value);
}
city.addEventListener("click", handleFavoriteSelection);
fetchAndUpdateForecast("Paris");

},{"./api":"9u7qN","./search":"4TESp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5q5fe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateCurrentDate", ()=>updateCurrentDate);
...
function getDayNumberOrder(dayNumber) {
    if (dayNumber == 1) return "st";
    else if (dayNumber == 2) return "nd";
    else if (dayNumber == 3) return "rd";
    else return "th";
}
function updateCurrentDate(city) {
    const temperatureUnit = "metric";
    dayli.classList.remove("is-hidden");
    (0, _apiJs.fetchCurrentWeather)(city, temperatureUnit).then((weatherData)=>{
...
},{"./api.js":"9u7qN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cHLki":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateSelectedCity", ()=>updateSelectedCity);
var _createMarkup = require("./create-markup");
var _api = require("./api");
var _fiveDays = require("./five-days");
...
(0, _createMarkup.createMarkup)(markup);
...
const moreInfo = async (event)=>{
    ...
    try {
        fiveDayData = await (0, _api.fetchForecast)(selectedCity, temperatureUnit);
        if (fiveDayData) {
            moreInfoData = getThreeHourlyData(fiveDayData, day);
            const dayData = moreInfoData;
            const markup1 = (0, _createMarkup.createMarkup)(dayData);
            moreInfoElement.innerHTML = markup1;
        }
    } catch (error) {
        console.error("Error while fetching weather data: ", error);
    }
...
},{"./create-markup":"4I6tI","./api":"9u7qN","./five-days":"1XLKS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4I6tI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createMarkup", ()=>createMarkup);
function createMarkup(markup) {
    const infoArr = markup.map(({ time , weatherIconName , temperature , pressure , humidity , wint  })=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4mmsu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateCurrentWeather", ()=>updateCurrentWeather);
var _apiJs = require("./api.js");
const city = "";
const temperatureElement = document.querySelector(".today-weather__current");
const minTemperatureElement = document.querySelector(".today-minmax__mindegree");
const maxTemperatureElement = document.querySelector(".today-minmax__maxdegree");
...
function fetchWeatherData(city1, temperatureUnit) {
    return (0, _apiJs.fetchCurrentWeather)(city1, temperatureUnit);
}
function updateCurrentWeather(city2) {
    const temperatureUnit = "metric";
    fiveDaysSection.classList.add("is-hidden");
    ...
    fetchWeatherData(city2, temperatureUnit).then((weatherData)=>{
...
},{"./api.js":"9u7qN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4jBvm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    async function fetchAndRenderChart(e) {
        ...
        try {
            ...
            const forecastData = await (0, _api.fetchForecast)(cityValue, temperatureUnit1);
    ...
    function getDailyData(forecastData) {
        return forecastData.list.filter((item, index, self)=>index === self.findIndex((t)=>new Date(t.dt * 1000).getDay() === new Date(item.dt * 1000).getDay()));
    }
    ...
    favoritesList.addEventListener("click", (event)=>{
        if (event.target.classList.contains("favorite-button")) {
            ...
            handleSelectedFavorite(cityValue, temperatureUnit1);
            fetchAndRenderFavoriteChart(cityValue, temperatureUnit1);
        }
    });
    ...
    function handleSelectedFavorite(cityValue, temperatureUnit2) {
        fetchAndRenderFavoriteChart(cityValue, temperatureUnit2);
    }
    function renderChart(dailyData) {
        const labels = dailyData.map((item)=>new Date(item.dt * 1000).toLocaleDateString("default", {
                day: "numeric",
                month: "short"
            }));
        ...
        weatherChart = new (0, _autoDefault.default)(chartCanvas, {
            type: "line",
            data: {
                labels: labels,
                datasets: [
...
},{"chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./api":"9u7qN"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kaFCt":[function(require,module,exports) {
...
function checkButtonVisibility() {
    if (window.innerWidth < 768) btnShowRight.classList.remove("is-hidden");
    else if (window.innerWidth >= 768 && moreInfoClicked) btnShowRight.classList.remove("is-hidden");
    else btnShowRight.classList.add("is-hidden");
}
checkButtonVisibility();

},{}],"gYKtQ":[function(require,module,exports) {
...
function open5Days() {
    ...
    if (fiveDaysSection.classList.contains("is-hidden")) {
        ...
        quote.classList.remove("is-hidden");
    } else todaySection.classList.add("is-hidden");
    quote.classList.add("is-hidden");
    dateSection.classList.add("is-hidden");
    chart.classList.add("is-hidden");
    showChartBtn.classList.remove("is-hidden");
    if (window.matchMedia("(min-width: 1280px)").matches) buttonList.classList.add("style-fivedays");
}
